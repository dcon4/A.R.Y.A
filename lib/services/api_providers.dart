...
final List<ApiProvider> apiProviders = [
  ...
  ApiProvider(
    ...
    models: const [
      ApiModel(id: 'llama-3.3-70b-versatile', label: 'Llama 3.3 70B Versatile'),
      ApiModel(id: 'llama-3.1-8b-instant', label: 'Llama 3.1 8B Instant'),
      ApiModel(id: 'llama-3.2-1b-preview', label: 'Llama 3.2 1B Preview'),
      ApiModel(id: 'llama-3.2-3b-preview', label: 'Llama 3.2 3B Preview'),
